...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/TemperatureControlSystem',
      component: Layout,
      children: [
        {
          path: 'tempectrl',
          component: () => import(/* webpackChunkName: "dashboard" */ '@/views/temp-ctrl-system/index.vue'),
          meta: {
            title: '温度控制系统',
            icon: 'dashboard'
          }
    ...
    },
    {
      ...
      children: [
        {
          path: 'QueryGraphs',
          component: () => import(/* webpackChunkName: "dashboard" */ '@/views/query-graphs/index.vue'),
          meta: {
            title: '查询图表',
            icon: 'dashboard'
          }
